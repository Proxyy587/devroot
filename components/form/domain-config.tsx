...
//         />
//       </div>
//       <p className="text-lg font-semibold dark:text-white">Completed</p>

//       <p className="text-sm dark:text-white">
//         Please set the following TXT record on{" "}
//         <InlineSnippet>APEX</InlineSnippet> to prove ownership of{" "}
//         <InlineSnippet>nigga</InlineSnippet>:
//       </p>
...
//           <p className="mt-2 font-mono text-sm">idk</p>
//         </div>
//         <div>
...
//         record will transfer domain ownership away from that site and break it.
//         Please exercise caution when setting this record.
//       </p>
